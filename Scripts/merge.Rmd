...
csv_files <- list.files("2_reviews_per_movie_raw/", full.names = TRUE, pattern = "\\.csv$")
...
csv_files <- list.files("1_movies_per_genre/", full.names = TRUE, pattern = "\\.csv$")
...
write_csv(x = merged_data,file = "review_dataframe.csv")
```
